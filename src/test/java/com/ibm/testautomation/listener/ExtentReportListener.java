...
public class ExtentReportListener {
	...
	public static ExtentReports setUp() {
		String reportLocation = System.getProperty("screenshotDirectory", "Reports") + File.separator
				+  System.getProperty("appname") + System.currentTimeMillis() +".html" ;
	...
	public static String captureScreenShot(WebDriver driver) throws IOException {
		...
		String screenshotDirectory = System.getProperty("screenshotDirectory", "target/screenshots/" + System.getProperty("appname") + File.separator + dateFormat.format(date));
		String screenshotAbsolutePath = screenshotDirectory + File.separator + + System.currentTimeMillis() + ".jpg";
